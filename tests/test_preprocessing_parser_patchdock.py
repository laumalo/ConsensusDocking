...
def parser():
    ...
    return ParserPatchDock(working_dir=base_dir, score_filename='output.txt')
...
class TestParserPatchDock:
    """
    It wraps all tests that involve the ParserPatchDock class
    """
    def test_initialization(self, tmp_path):
        ...
        p = ParserPatchDock(working_dir=base_dir, score_filename=sc_filename)
        assert isinstance(p, ParserPatchDock)
    ...
    def test_validate_read(self, parser):
        ...
        desired_col_names = ['conf_index', 'score', 'pen.', 'Area', 'as1',
                             'as2', 'as12', 'ACE', 'hydroph', 'Energy',
                             'cluster', 'dist.', 'Ligand Transformation']
    ...
    def test_invalid_sc_file(self, tmp_path):
        ...
        with pytest.raises(Exception):
            ParserPatchDock(working_dir=tmp_path, score_filename='dummy')
