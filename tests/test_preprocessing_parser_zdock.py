...
def parser():
    ...
    return ParserZDock(working_dir=base_dir, score_filename='dock.ene')
...
class TestParserZDock:
    """
    It wraps all tests that involve the ParserZDock class
    """
    ...
    def test_invalid_sc_file(self, tmp_path):
        ...
        with pytest.raises(Exception):
            ParserZDock(working_dir=tmp_path, score_filename='dummy')
