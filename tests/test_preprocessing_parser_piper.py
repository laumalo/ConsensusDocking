...
def parser():
    ...
    return ParserPiper(working_dir=base_dir, score_filename='ft.000.00')
...
class TestParserPiper:
    ...
    def test_initialization(self, tmp_path):
        ...
        p = ParserPiper(working_dir=base_dir, score_filename=sc_filename)
        assert isinstance(p, ParserPiper)
    ...
    def test_validate_read(self, parser):
        ...
        desired_col_names = ['rot_index', 'x_trans', 'y_trans', 'z_trans',
                             'total_score', 'repulsive_vdw', 'attractive_vdw',
                             'coulomb_elect', 'born_approx_elect',
                             'pairwise_potential']
    ...
    def test_invalid_sc_file(self, tmp_path):
        ...
        with pytest.raises(Exception):
            ParserPiper(working_dir=tmp_path, score_filename='dummy')
