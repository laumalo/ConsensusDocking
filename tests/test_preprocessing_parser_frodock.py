...
def parser():
    ...
    return ParserFroDock(working_dir=base_dir, score_filename='dock.dat')
...
class TestParserPiper:
    ...
    def test_initialization(self, tmp_path):
        ...
        p = ParserFroDock(working_dir=base_dir, score_filename=sc_filename)
        assert isinstance(p, ParserFroDock)
    ...
    def test_validate_read(self, parser):
        ...
        desired_col_names = ['rank_id', 'Euler1', 'Euler2', 'Euler3', 'posX',
                             'posY', 'posZ', 'correlation']
    ...
    def test_invalid_sc_file(self, tmp_path):
        ...
        with pytest.raises(Exception):
            ParserFroDock(working_dir=tmp_path, score_filename='dummy')
