...
class ParserEncoding:
    ...
    def parse(self):
        """
        Parses the encoding file in `encoding_file_path` and saves it as DataFrame in self.df.
        """
        self.df = pd.read_csv(self.encoding_file_path, header=0)
        # self.__add_program_col()
    ...
    def __add_program_col(self):
        ...
        ----------
        NOTE: This method is not currently used but it could be useful for get_program_weights method.
        """
